...
$PackageContexts={
		"PyTools`",
		"PyTools`Private`Package`",
		"PyTools`Private`Hidden`"
		};
$PackageDeclared=
...
PackageScopeBlock[e_,scope_String:"Hidden"]:=
	With[{newcont="PyTools`Private`"<>StringTrim[scope,"`"]<>"`"},
...
PackageDecontext[
	...
	With[{
		...
		ctx="PyTools`Private`"<>StringTrim[scope,"`"]<>"`"
		},
		Replace[names,
...
If[(Clear@PyTools`Private`Package`$loadAbort;!#)&@PyTools`Private`Package`$loadAbort,
	PyTools`Private`Package`PackagePostProcessContextPathReassign[]
	]